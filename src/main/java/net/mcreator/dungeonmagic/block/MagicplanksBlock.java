...
public class MagicplanksBlock extends DungeonmagicModElements.ModElement {
	@ObjectHolder("dungeonmagic:magicplanks")
	public static final Block block = null;

	public MagicplanksBlock(DungeonmagicModElements instance) {
		super(instance, 11);
	}
