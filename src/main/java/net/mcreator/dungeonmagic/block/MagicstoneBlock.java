...
public class MagicstoneBlock extends DungeonmagicModElements.ModElement {
	@ObjectHolder("dungeonmagic:magicstone")
	public static final Block block = null;

	public MagicstoneBlock(DungeonmagicModElements instance) {
		super(instance, 9);
	}
