...
public class MagicgrassBlock extends DungeonmagicModElements.ModElement {
	@ObjectHolder("dungeonmagic:magicgrass")
	public static final Block block = null;

	public MagicgrassBlock(DungeonmagicModElements instance) {
		super(instance, 8);
	}
